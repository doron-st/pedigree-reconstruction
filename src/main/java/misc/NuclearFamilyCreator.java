...
public class NuclearFamilyCreator {
    ...
    private Graph graph;
    private List<NucFamily> allFamilies;
    private int generation;
    private NextIDGenerator nextIDGen;
    ...
    private void createNucFamilyForSiblings(List<NucFamily> nucFamilies, List<Person> siblingsPersons,
        ...
        if (motherToSiblings.size() == 1 && fatherToSiblings.size() == 1) {
            ...
            NucFamily nucFamily = new NucFamily(mother, father, motherToSiblings.get(mother), graph);
            ...
            NucFamily nucFamily1 = new NucFamily(mother, father1, fatherToSiblings.get(father1), graph);
            newNucFamilies.add(nucFamily1);
            NucFamily nucFamily2 = new NucFamily(mother, father2, fatherToSiblings.get(father2), graph);
            ...
            NucFamily nucFamily1 = new NucFamily(mother1, father, motherToSiblings.get(mother1), graph);
            newNucFamilies.add(nucFamily1);
            NucFamily nucFamily2 = new NucFamily(mother2, father, motherToSiblings.get(mother2), graph);
            newNucFamilies.add(nucFamily2);
            ...
            NucFamily nucFamily1 = new NucFamily(mother1, father1, motherToSiblings.get(mother1), graph);
            newNucFamilies.add(nucFamily1);
            NucFamily nucFamily2 = new NucFamily(mother2, father2, motherToSiblings.get(mother2), graph);
            newNucFamilies.add(nucFamily2);
        } else {
    ...
    private void addNewSibsToFamily(List<NucFamily> nucFamilies, List<Vertex> siblings) {
        ...
        for (Vertex v : siblings) {
            ...
            if (s.getFamily().father == null || s.getFamily().mother == null) {
                s.getFamily().father = (Person) fam.getFather();
                s.getFamily().mother = (Person) fam.getMother();

...
public class TestCommonParentHypothesis {
    ...
    private void testCommonParent(Pedigree ped, Graph IBDgraph,
        ...
        nucFamilies.add(new NucFamily(new Person(1, "1", 50, false, 1), new Person(2, "2", 50, true, 1), sib1, IBDgraph));
        nucFamilies.add(new NucFamily(new Person(3, "3", 50, false, 1), new Person(4, "4", 50, true, 1), sib2, IBDgraph));

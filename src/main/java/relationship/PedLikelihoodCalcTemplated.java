...
public class PedLikelihoodCalcTemplated extends PedLikelihoodCalcAbs{
	...
	private Map<String, List<Pedigree>> templatesBySize = new HashMap<String,List<Pedigree>>();
	private Map<Pedigree,Map<String,MultivariateKDE>> kdeMapsByTemplate = new HashMap<Pedigree,Map<String,MultivariateKDE>>();
	private Map<Pedigree,Map<String, List<DataPoint>>>  dataSetMap = new HashMap<Pedigree,Map<String, List<DataPoint>>>();
